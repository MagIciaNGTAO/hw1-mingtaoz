...
public class Sentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.mingtaoz.type.Sentence");
  ...
  public String getSentence(int addr) {
      ...
      jcas.throwFeatMissing("Sentence", "edu.cmu.mingtaoz.type.Sentence");
