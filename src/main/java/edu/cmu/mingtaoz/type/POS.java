...
public class POS extends Annotation {
  ...
  /** getter for PartOfSpeech - gets NN in part of speech
   * @generated */
  public String getPartOfSpeech() {
    if (POS_Type.featOkTst && ((POS_Type)jcasType).casFeat_PartOfSpeech == null)
      jcasType.jcas.throwFeatMissing("PartOfSpeech", "edu.cmu.mingtaoz.type.POS");
    return jcasType.ll_cas.ll_getStringValue(addr, ((POS_Type)jcasType).casFeatCode_PartOfSpeech);}
    
  /** setter for PartOfSpeech - sets NN in part of speech 
   * @generated */
  public void setPartOfSpeech(String v) {
    if (POS_Type.featOkTst && ((POS_Type)jcasType).casFeat_PartOfSpeech == null)
      jcasType.jcas.throwFeatMissing("PartOfSpeech", "edu.cmu.mingtaoz.type.POS");
    jcasType.ll_cas.ll_setStringValue(addr, ((POS_Type)jcasType).casFeatCode_PartOfSpeech, v);}    
  }
