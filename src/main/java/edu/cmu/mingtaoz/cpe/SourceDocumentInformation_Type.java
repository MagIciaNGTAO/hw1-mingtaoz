...
public class SourceDocumentInformation_Type extends Annotation_Type {
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.mingtaoz.cpe.SourceDocumentInformation");
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "edu.cmu.mingtaoz.cpe.SourceDocumentInformation");
  ...
  public int getOffsetInSource(int addr) {
      ...
      jcas.throwFeatMissing("offsetInSource", "edu.cmu.mingtaoz.cpe.SourceDocumentInformation");
  ...
  public int getDocumentSize(int addr) {
      ...
      jcas.throwFeatMissing("documentSize", "edu.cmu.mingtaoz.cpe.SourceDocumentInformation");
  ...
  public boolean getLastSegment(int addr) {
      ...
      jcas.throwFeatMissing("lastSegment", "edu.cmu.mingtaoz.cpe.SourceDocumentInformation");
